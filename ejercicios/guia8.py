...
# 1) Con la clase creada en el módulo 7, tener en cuenta diferentes casos en que el 
# código pudiera arrojar error. 
# Por ejemplo, en la creación del objeto recibimos una lista de números enteros pero 
...
#from funciones import *
#f = funciones([2,5,7,8])
#print(f.Conversion_grados('Kelvin','Celsius'))


# 3) Importar el modulo "unittest" y crear los siguientes casos de pruebas sobre la 
# clase utilizada en el punto 2<br>
...
class Prueba(unittest.TestCase):
    ...
    def test_Creacion_de_objeto(self):
        lista=[1,'hola']   
        self.assertRaises(ValueError,funciones, lista)
...
#9) Completar el código en las funciones del archivo "checkpoint.py" 
# y probarlo a partir de la ejecución del script "tests.py"